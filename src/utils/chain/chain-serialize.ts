...
function serializeUnknown(this: {
  name: string;
  aliasOfName: // copyright defined in fiojs/LICENSE.txt
  string;
  arrayOf: Type | null;
  optionalOf: Type | null;
  extensionOf: Type | null;
  ...
  fields: Field[];
  serialize: (
    buffer: /** A field in an abi */
    SerialBuffer,
    data: any,
    state?: SerializerState /** Field name */ | undefined,
    allowExtensions?: boolean | undefined
  ) => void;
  deserialize: (
    buffer: SerialBuffer,
    state?: SerializerState | undefined,
    allowExtensions?: boolean | undefined
  ) => any;
}): SerialBuffer {
